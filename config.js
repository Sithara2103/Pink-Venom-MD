...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PINKVENOM-MD;ScEBCZwI#yxRM9-SVKxURFCchBoqCTF8aoIj4uSFq91tlTPZXmUA' : process.env.SESSION_ID, //ADD YOUR SESSION ID
    GITHUB_USER_NAME: process.env.GITHUB_USER_NAME === undefined ? 'config.js' : process.env.GITHUB_USER_NAME, //ADD YOUR GITHUB USERNAME
